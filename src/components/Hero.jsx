      ...
      <SwiperSlide>
        ...
        >
           <div className='flex flex-col items-center text-center sm:text-start sm:items-start gap-9 py-14 w-[268px] sm:w-[1044px]'>
            <p>SUMMER 2020</p>
            <p className='font-bold text-[40px] sm:text-[58px]'>NEW COLLECTION</p>
            <p className='font-normal text-xl w-[340px]'>We know how large objects will act, 
            but things on a small scale.</p>
            <div>
            <button className='px-10 py-4 bg-[#2DC071] font-bold text-2xl rounded-[5px]'>SHOP NOW</button>
            </div>
          </div>
        </div>
      </SwiperSlide>
